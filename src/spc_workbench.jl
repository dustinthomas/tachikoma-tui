...
function _mode_key_entries(mode::Symbol; compact::Bool = true)
    ...
    elseif mode === :help
        return [
            ...
            (:binds, [("q", "close"), ("O", "HTML docs (browser)")]),
            (:note, "O opens shipped docs/build HTML · rebuild after edits: julia --project=docs docs/make.jl"),
            (:section, "DASHBOARD"),
            (:binds, [("p", "pause"), ("g", "live"), ("[ ]", "chart"), ("←→", "pan")]),
            (:binds, [("r/z", "reset"), ("u/t/l", "specs"), ("1-8", "WECO"), ("w", "explain")]),
            (:binds, [("s", "clear specs"), ("c", "config"), ("f/F", "filter"), ("o", "visual")]),
            (:binds, [("v", "lines"), ("m", "library"), ("x", "tools"), ("d", "table")]),
            (:section, "CONFIG (full page · c/v/o/e)"),
            (:note, "Rules · Lines · Visual · Saved · Tab · Esc/q · s/w Save As · W Load"),
            (:note, "WECO load → active chart + session defaults (not all charts)"),
            (:section, "VISUALS · LIBRARY · TABLE · TOOLS"),
            (:note, "◆ OOC · ✕ OOS · Cpk colors · lib a/c/n/d · table r rematerialize"),
            (:note, "mode-gated: dash w=explain · tools master ids · builder assigns"),
        ]
    elseif mode === :keymap
        return [
            (:section, "KEYS"),
            ...
            (:binds, [("O", "HTML docs (browser)")]),
            (:note, "O opens shipped docs/build (index) · rebuild after docs edits if missing"),
            (:section, "CONFIG"),
